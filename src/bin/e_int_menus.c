...
static Eina_Bool   _e_int_menus_app_config_append(Efreet_Desktop *desktop);
...
EAPI Eina_Bool
e_int_menus_cache_update(Efreet_Desktop *desktop)
{
   if (!desktop) return EINA_FALSE;
   return _e_int_menus_app_config_append(desktop);
}
