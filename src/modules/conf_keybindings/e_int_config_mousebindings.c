...
#define CFG_MOUSEBIND_DFLT(_context, _button, _modifiers, _anymod, _action, _params) \
  ...
  cfdata->binding.mouse = eina_list_append(cfdata->binding.mouse, eb)
   ...
   CFG_MOUSEBIND_DFLT(E_BINDING_CONTEXT_WINDOW, 1, E_BINDING_MODIFIER_ALT | E_BINDING_MODIFIER_CTRL, 0, "window_move", NULL);
   CFG_MOUSEBIND_DFLT(E_BINDING_CONTEXT_WINDOW, 2, E_BINDING_MODIFIER_ALT | E_BINDING_MODIFIER_CTRL, 0, "window_resize", NULL);
   CFG_MOUSEBIND_DFLT(E_BINDING_CONTEXT_WINDOW, 3, E_BINDING_MODIFIER_ALT | E_BINDING_MODIFIER_CTRL, 0, "window_menu", NULL);
   CFG_MOUSEBIND_DFLT(E_BINDING_CONTEXT_WINDOW, 1, E_BINDING_MODIFIER_WIN, 0, "window_move", NULL);
   CFG_MOUSEBIND_DFLT(E_BINDING_CONTEXT_WINDOW, 2, E_BINDING_MODIFIER_WIN, 0, "window_resize", NULL);
   CFG_MOUSEBIND_DFLT(E_BINDING_CONTEXT_WINDOW, 3, E_BINDING_MODIFIER_WIN, 0, "window_menu", NULL);
